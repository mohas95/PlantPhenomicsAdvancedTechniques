...
While not all conditions can be isolated and controlled, factors such light intensity, schedule, and spectrum, air and root zone temperature, humidity, CO\textsubscript{2} concentration, and nutrient conditions and delivery methods are well monitored and regulated \cite{srivani2019controlled} (Table \ref{tab:CEA_parameters}).

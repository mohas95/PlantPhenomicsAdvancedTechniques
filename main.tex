...
\subsubsection{Rebuttal: Comparing Controlled and Open Field Agricultural Systems}
To contextualize the focus of this review, it is necessary to highlight the differences in the observational parameters between controlled environment and open field agricultural systems. Open field environments are characterized by 

\subsubsection{Predictive Modeling in Agriculture}

...
While not all conditions can be isolated and controlled, factors such light intensity, schedule, and spectrum, air and root zone temperature, humidity, CO\textsubscript{2} concentration, nutrient conditions and delivery methods are well monitored and regulated \cite{srivani2019controlled} (Table \ref{tab:CEA_parameters}).
...
\subsection{Rebuttal: Defining Simulated Environments and Plant Growth}
